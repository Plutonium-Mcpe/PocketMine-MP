...
final class CommonProperties{
	...
	private function __construct(){
		...
		$this->stairProperties = [
			...
			new ValueFromStringProperty(StateNames::MC_CORNER, $vm->stairShape, fn(Stair $b) => $b->getShape(), fn(Stair $b, StairShape $v) => $b->setShape($v), defaultRawWhenMissing: BlockStateStringValues::MC_CORNER_NONE),
		];
